...
- (UILabel *)shadedLabelWithText:(NSString *)label ofSize:(CGFloat)pointSize {
    ...
    CGSize size = [label sizeWithAttributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:pointSize]}];
...
- (void)addLabel:(NSString *)label ofSize:(CGFloat)pointSize toComponent:(NSInteger)component leftAlignedAt:(CGFloat)offset baselineAlignedWithFontOfSize:(CGFloat)titlePointSize {
    ...
    CGFloat baselineHeight = [@"X" sizeWithAttributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:titlePointSize]}].height;
    CGFloat labelHeight = [@"X" sizeWithAttributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:pointSize]}].height;
